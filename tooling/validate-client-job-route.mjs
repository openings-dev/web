...
assert.match(redirects, /^\/authors\/\s+\/authors\/index\.html\s+200$/mu);
assert.match(redirects, /^\/users\/\s+\/users\/index\.html\s+200$/mu);
assert.match(redirects, /^\/communities\/\s+\/communities\/index\.html\s+200$/mu);
assert.match(redirects, /^\/community\/\s+\/community\/index\.html\s+200$/mu);
